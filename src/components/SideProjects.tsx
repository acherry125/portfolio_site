...
const PROJECTS = [
  {
    ...
    type: 'Mobile App',
    title: 'Fisherbird',
    desc: 'A mobile app company I co-founded. Building consumer apps with on-device AI, content moderation, and spice quantity estimation via ML.',
    tech: 'React Native / TFLite / On-device ML',
  },
  {
    id: 'the-city',
    type: 'Game',
    title: 'The City',
    desc: 'A text-adventure game exploring a war-torn Boston City Hall. Built in React as a narrative experiment with branching storylines.',
  ...
  },
  {
    ...
    type: 'Game',
    title: 'Worship',
    desc: 'A village-god simulator built in Java. Play as a deity managing a civilization with resource allocation, belief systems, and natural disasters.',
